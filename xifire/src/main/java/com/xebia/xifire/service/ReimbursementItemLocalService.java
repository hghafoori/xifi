...
/**
 * Provides the local service interface for ReimbursementItem. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ReimbursementItemLocalServiceUtil
...
public interface ReimbursementItemLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link ReimbursementItemLocalServiceUtil} to access the reimbursement item local service. Add custom service methods to {@link com.xebia.xifire.service.impl.ReimbursementItemLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
