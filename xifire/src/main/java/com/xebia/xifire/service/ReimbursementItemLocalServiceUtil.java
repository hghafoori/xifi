...
/**
 * Provides the local service utility for ReimbursementItem. This utility wraps
 * {@link com.xebia.xifire.service.impl.ReimbursementItemLocalServiceImpl} and is the
 ...
 * @see com.xebia.xifire.service.base.ReimbursementItemLocalServiceBaseImpl
 * @see com.xebia.xifire.service.impl.ReimbursementItemLocalServiceImpl
 * @generated
 */
public class ReimbursementItemLocalServiceUtil {
    private static ReimbursementItemLocalService _service;

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify this class directly. Add custom service methods to {@link com.xebia.xifire.service.impl.ReimbursementItemLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
     */
    ...
    */
    public static com.xebia.xifire.model.ReimbursementItem addReimbursementItem(
        com.xebia.xifire.model.ReimbursementItem reimbursementItem)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().addReimbursementItem(reimbursementItem);
    }
    ...
    */
    public static com.xebia.xifire.model.ReimbursementItem deleteReimbursementItem(
        com.xebia.xifire.model.ReimbursementItem reimbursementItem)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().deleteReimbursementItem(reimbursementItem);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<com.xebia.xifire.model.ReimbursementItem> getReimbursementItems(
        int start, int end)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().getReimbursementItems(start, end);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static int getReimbursementItemsCount()
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().getReimbursementItemsCount();
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.xebia.xifire.model.ReimbursementItem updateReimbursementItem(
        com.xebia.xifire.model.ReimbursementItem reimbursementItem)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().updateReimbursementItem(reimbursementItem);
    }

    public static com.xebia.xifire.model.ReimbursementItemDocumentBlobModel getDocumentBlobModel(
    ...
    */
    ...
    public static ReimbursementItemLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    ReimbursementItemLocalService.class.getName());

            if (invokableLocalService instanceof ReimbursementItemLocalService) {
                _service = (ReimbursementItemLocalService) invokableLocalService;
            } else {
                _service = new ReimbursementItemLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(ReimbursementItemLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(ReimbursementItemLocalService service) {
    }
}
