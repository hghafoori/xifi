 ...
 * {@link com.xebia.xifire.service.impl.SalaryLocalServiceImpl} and is the
...
public class SalaryLocalServiceUtil {
    private static SalaryLocalService _service;

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify this class directly. Add custom service methods to {@link com.xebia.xifire.service.impl.SalaryLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
     */
    ...
    */
    public static com.xebia.xifire.model.Salary addSalary(
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.xebia.xifire.model.Salary deleteSalary(
        com.xebia.xifire.model.Salary salary)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<com.xebia.xifire.model.Salary> getSalaries(
        int start, int end)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.xebia.xifire.model.Salary updateSalary(
        com.xebia.xifire.model.Salary salary)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    */
    ...
    public static SalaryLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    SalaryLocalService.class.getName());

            if (invokableLocalService instanceof SalaryLocalService) {
                _service = (SalaryLocalService) invokableLocalService;
            } else {
                _service = new SalaryLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(SalaryLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(SalaryLocalService service) {
    }
}
