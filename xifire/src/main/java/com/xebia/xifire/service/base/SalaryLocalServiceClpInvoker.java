 ...
 * @generated
 */
public class SalaryLocalServiceClpInvoker {
    ...
    public SalaryLocalServiceClpInvoker() {
        ...
        _methodParameterTypes0 = new String[] { "com.xebia.xifire.model.Salary" };
        ...
        _methodParameterTypes3 = new String[] { "com.xebia.xifire.model.Salary" };
        ...
        _methodName13 = "getSalaries";

        _methodParameterTypes13 = new String[] { "int", "int" };

        _methodName14 = "getSalariesCount";

        _methodParameterTypes14 = new String[] {  };

        _methodName15 = "updateSalary";

        _methodParameterTypes15 = new String[] { "com.xebia.xifire.model.Salary" };
    ...
    public Object invokeMethod(String name, String[] parameterTypes,
        ...
        if (_methodName0.equals(name) &&
            ...
            return SalaryLocalServiceUtil.addSalary((com.xebia.xifire.model.Salary) arguments[0]);
        }
        ...
        if (_methodName3.equals(name) &&
            ...
            return SalaryLocalServiceUtil.deleteSalary((com.xebia.xifire.model.Salary) arguments[0]);
        }

        if (_methodName4.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes4, parameterTypes)) {
            return SalaryLocalServiceUtil.dynamicQuery();
        }

        if (_methodName5.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes5, parameterTypes)) {
            return SalaryLocalServiceUtil.dynamicQuery((com.liferay.portal.kernel.dao.orm.DynamicQuery) arguments[0]);
        }
        ...
        if (_methodName8.equals(name) &&
            ...
            return SalaryLocalServiceUtil.dynamicQueryCount((com.liferay.portal.kernel.dao.orm.DynamicQuery) arguments[0]);
        }
        ...
        if (_methodName12.equals(name) &&
            ...
            return SalaryLocalServiceUtil.getPersistedModel((java.io.Serializable) arguments[0]);
        }

        if (_methodName13.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes13, parameterTypes)) {
            return SalaryLocalServiceUtil.getSalaries(((Integer) arguments[0]).intValue(),
                ((Integer) arguments[1]).intValue());
        }

        if (_methodName14.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes14, parameterTypes)) {
            return SalaryLocalServiceUtil.getSalariesCount();
        }

        if (_methodName15.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes15, parameterTypes)) {
            return SalaryLocalServiceUtil.updateSalary((com.xebia.xifire.model.Salary) arguments[0]);
        }

        if (_methodName44.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes44, parameterTypes)) {
            return SalaryLocalServiceUtil.getBeanIdentifier();
        }
